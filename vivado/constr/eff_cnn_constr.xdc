...
create_clock -period 2.5 -name clk_main -waveform {0.000 1.25} [get_ports clk]

set_property MAX_FANOUT 26000 [get_nets dig_top_inst/pipe_fifo_bpress_batch_norm/upstream_pipe_ctrl_if\\.step]
set_property MAX_FANOUT 8000 [get_nets dig_top_inst/sys_arr_inst/sys_arr_rst_n]

## Set input delay constraints for slave AXI stream interface
#set_input_delay -clock clk_main -max 2.4 [get_ports S_AXIS_TDATA]
#set_input_delay -clock clk_main -min 1.6 [get_ports S_AXIS_TDATA]
#
#set_input_delay -clock clk_main -max 2.4 [get_ports S_AXIS_TLAST]
#set_input_delay -clock clk_main -min 1.6 [get_ports S_AXIS_TLAST]
#
#set_input_delay -clock clk_main -max 2.4 [get_ports S_AXIS_TID]
#set_input_delay -clock clk_main -min 1.6 [get_ports S_AXIS_TID]
#
#set_input_delay -clock clk_main -max 2.4 [get_ports S_AXIS_TVALID]
#set_input_delay -clock clk_main -min 1.6 [get_ports S_AXIS_TVALID]
#
#set_output_delay -clock clk_main -max 2.4 [get_ports S_AXIS_TREADY]
#set_output_delay -clock clk_main -min 1.6 [get_ports S_AXIS_TREADY]
#
#set_output_delay -clock clk_main -max 2.4 [get_ports M_AXIS_TDATA]
#set_output_delay -clock clk_main -min 1.6 [get_ports M_AXIS_TDATA]
#
#set_output_delay -clock clk_main -max 2.4 [get_ports M_AXIS_TLAST]
#set_output_delay -clock clk_main -min 1.6 [get_ports M_AXIS_TLAST]
#
#set_output_delay -clock clk_main -max 2.4 [get_ports M_AXIS_TID]
#set_output_delay -clock clk_main -min 1.6 [get_ports M_AXIS_TID]
#
#set_output_delay -clock clk_main -max 2.4 [get_ports M_AXIS_TVALID]
#set_output_delay -clock clk_main -min 1.6 [get_ports M_AXIS_TVALID]
#
#set_input_delay -clock clk_main -max 2.4 [get_ports M_AXIS_TREADY]
#set_input_delay -clock clk_main -min 1.6 [get_ports M_AXIS_TREADY]
